...
let stringyIndexes = strings => {
  let indexCount = -1;
  return strings.map(string => {
    indexCount += 1;
    return string + " is at index " + indexCount;
  });
};
...
let onlyTheEvenSurvive = numbers => {
...
let onlyTheEvenIndexedSurvive = numbers => {
